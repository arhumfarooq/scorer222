...
// // //              SizedBox(width: 32,)
// // //              , BoldText(text: "Administrator Login",selectionColor: AppColors.blueColor,)
// // //             ],
// // //           ),
// // //           SizedBox(height: 20,),
// // //           Image.asset(Appimages.prince2),
// // //           SizedBox(height: 23,),
...
// //                 //     ),
// //                 //     SizedBox(width: 45 * widthScaleFactor),
// //                 //     BoldText(
      ...
      body: GradientBackground(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return SafeArea(
              child: SingleChildScrollView(
                // 👇 scroll karega keyboard open hone par
                padding: EdgeInsets.symmetric(horizontal: 32 * widthScaleFactor),
                child: ConstrainedBox(
                  constraints: BoxConstraints(
                    minHeight: constraints.maxHeight, // 👈 column ko full height tak stretch karega
                  ),
                  child: IntrinsicHeight(
                    child: Column(
                      children: [
                        ...
                        // 👇 Yahan Spacer ab kaam karega bina overflow ke
                    SizedBox(height: 30 * heightScaleFactor),
