    ...
    return Scaffold(
      body: GradientBackground(child: SafeArea(child: Stack(
        children: [
          ...
          //             child: Center(
          //               child: MainText(
          //                   text: "2", color: AppColors.whiteColor, fontSize: 11),
          //             ),
          //           ),
          //     SizedBox(width: 7),
          ...
          //       child: Center(
          //         child:
          //             MainText(text: "3", color: AppColors.whiteColor, fontSize: 11),
          //       ),
          //     ),
          //   ],
          // )),
          ...
          //                                        )
          // Obx(() {
          //   // Show Back button only after 2 clicks
          ...
          //               controller.clickCount.value = 0; // Reset counter
          //             },
          //             text: "Back",
          ...
          //                   onTap: () {
          //                     // controller.clickCount.value += 1; // increment click count
          //                     controller.isCompleted.value = false; // Pause
          //                   },
          //                   text: "Pause",
          //                   color: AppColors.selectLangugaeColor,
          //                   height: 45 * heightScaleFactor,
          ...
          //                   onTap: () {
          //                     controller.clickCount.value += 1; // increment click count
          //                     controller.isCompleted.value = true; // Next Phase
          //                   },
          //                   text: "Next Phase",
          //                   icon: Icons.fast_forward,
          //                   color: controller.isCompleted.value? AppColors.forwardColor:AppColors.assignColor,
